...
python ~/github/SnowyOwl/appV3/snap_picture_webcam.py -ip $cam_ip -p 554 -u $cam_user -pwd $cam_pwd -o $image_dir

# ------- STEP 3: acquire point cloud --------
~/livox/bin/python ~/github/SnowyOwl/appV3/acquisition.py -d $scan_duration -o $scan_dir -ips $scan_ip -ipc $computer_ip
